...
class GuestModel {
  ...
  factory GuestModel.fromMap(Map<String, dynamic> map) => GuestModel(
    ...
    type: GuestType.values.firstWhere(
      (e) => e.name == map['type'],
      orElse: () => GuestType.other,
    ),
    numberOfGuests: map['numberOfGuests']?.toInt(),
    notes: map['notes'],
    qrCode: map['qrCode'],
    invitedAt: map['invitedAt'] != null ? DateTime.parse(map['invitedAt']) : null,
    respondedAt: map['respondedAt'] != null ? DateTime.parse(map['respondedAt']) : null,
    createdAt: DateTime.parse(map['createdAt']),
  );

  String toJson() => json.encode(toMap());
  factory GuestModel.fromJson(String source) => GuestModel.fromMap(json.decode(source));
