...
class EventProvider extends ChangeNotifier {
  ...
  List<EventModel> get completedEvents => _events
      .where((e) => e.status == EventStatus.completed)
      .toList();

  List<EventModel> get eventsByDate {
  ...
  void loadDummyData() {
    _events = [
      ...
      EventModel(
        id: '4',
        name: 'استقبال مولود نورا',
        type: EventType.babyShower,
        description: 'استقبال المولودة الجديدة',
        date: DateTime.now().add(const Duration(days: 20)),
        startTime: '05:00 مساءً',
        location: 'منزل العائلة، الدمام',
        budget: 3000,
        expectedGuests: 25,
        status: EventStatus.upcoming,
        themeColor: '#B3E5FC',
  ...
  List<EventModel> getEventsByMonth(int month, int year) {
