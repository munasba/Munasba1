...
class _CreateEventScreenState extends State<CreateEventScreen> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const TextField(maxLines: 5, decoration: InputDecoration(labelText: 'اكتب رسالة الدعوة...', alignLabelWithHint: true)),
          const SizedBox(height: 20),
          Container(
            padding: const EdgeInsets.all(20),
          ...
          children: [
            ...
            Expanded(
              ...
              child: ElevatedButton(
                onPressed: () { if (_currentStep < 2) { setState(() => _currentStep++); } else { _saveEvent(); } },
  ...
  void _saveEvent() { Navigator.pop(context); }
