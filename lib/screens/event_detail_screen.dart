...
class EventDetailScreen extends StatelessWidget {
      ...
      child: Column(
        children: [
          ...
          if (event.budget != null) ...[
            const Divider(),
            _buildInfoRow(Icons.account_balance_wallet, 'الميزانية',
                '${event.budget?.toStringAsFixed(0)} ر.س'),
          ],
          if (event.expectedGuests != null) ...[
            const Divider(),
            _buildInfoRow(Icons.people, 'الضيوف المتوقعين',
                '${event.expectedGuests} شخص'),
          ],
        ],
      ),
  ...
  Widget _buildQuickActions() {
    final actions = [
      ('الضيوف', Icons.people, Colors.blue),
      ('الميزانية', Icons.account_balance_wallet, Colors.green),
      ('المهام', Icons.task_alt, Colors.orange),
      ('المشاركة', Icons.share, Colors.purple),
    ];
              ...
              child: InkWell(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(action.$1, style: AppTextStyles.bodyLarge),
                  ],
                ),
              ),
            );
